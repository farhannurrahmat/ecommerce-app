        ...
        <span></span>
                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{ route('home.index')}}" id="">
                            <img class="" id="" alt="" src="{{asset('template/img/logo.png')}}">
                        </a>
                        ...
                        <div class="center-item">
                            <ul class="menu-list">
                                ...
                                <li class="menu-item has-children">
                                    <a href="javascript:void(0);" class="menu-item-button">
                                        <div class="icon"><i class="icon-layers"></i></div>
                                        <div class="text">Discount Categories</div>
                                    </a>
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.discount-categories.create')}}" class="">
                                                <div class="text">Add Discount Categories</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.discount-categories.index')}}" class="">
                                                <div class="text">Discount Categories</div>
                                            </a>
                                        </li>
                                    </ul>
                ...
                <div class="section-content-right">
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page fixed-bottom">
                            <div class="body-text">Copyright © 2024 Fruitables</div>
                        </div>
                    </div>
