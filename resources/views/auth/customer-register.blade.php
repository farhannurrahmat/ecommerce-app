                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('customer.register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="address1" class="form-control @error('address1') is-invalid @enderror" name="address1" required>{{ old('address1') }}</textarea>
                                @error('address1')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="address2" class="form-control" name="address2">{{ old('address2') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="address3" class="form-control" name="address3">{{ old('address3') }}</textarea>
                            </div>
                        </div>
