            ...
            <form class="tf-section-2 form-edit-product" method="POST" enctype="multipart/form-data"
                ...
                <div class="wg-box">
                    ...
                    <fieldset>
                        ...
                        <input class="mb-10" type="text" name="product_name"
                    ...
                    <fieldset>
                        ...
                        <textarea class="mb-5" name="description" placeholder="Enter product description" maxlength="1000" required>{{ old('description', $product->description) }}</textarea>
                    ...
                    <fieldset>
                        ...
                        <input type="number" name="stok_quantity"
                            value="{{ old('stok_quantity', $product->stok_quantity) }}" placeholder="Enter stock quantity"
                            min="1" required>
                        @error('stok_quantity')
                            <span class="alert alert-danger">{{ $message }}</span>
                        @enderror
                            ...
                            @for ($i = 1; $i <= 3; $i++)
                                <fieldset>
                                    ...
                                    <div class="upload-image flex-grow">
                                        <div class="item" id="imgpreview{{ $i }}"
                                            style="{{ $product->{'image' . $i . '_url'} ? '' : 'display:none' }}">
                                            <img src="{{ asset('uploads/products/' . $product->{'image' . $i . '_url'}) }}"
                                                class="effect8" alt="Image {{ $i }} Preview">
                                        </div>
